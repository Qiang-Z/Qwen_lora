...
CLASSES = ['car', 'person', 'bike']  # coco80类别
...
if __name__ == "__main__":
    ...
    onnx_path = '/mnt/zhouqiang/yolov5/yolov5-master/runs/train/exp4/weights/best.onnx'
    model = Yolov5ONNX(onnx_path)
    # output, or_img = model.inference('data/images/img.png')
    output, or_img = model.inference('/mnt/zhouqiang/yolov5/yolov5-master/data/auto_data/images/train/1a0407316e1333ebc8ecf05a8ea13d16.png')
    ...
    cv2.imwrite('/mnt/zhouqiang/yolov5/yolov5-master/res/res.jpg', or_img)
